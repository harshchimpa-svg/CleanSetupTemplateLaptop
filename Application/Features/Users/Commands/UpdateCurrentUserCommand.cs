...
internal class UpdateCurrentUserCommandHandler : IRequestHandler<UpdateCurrentUserCommand, Result<string>>
{
    ...
    public UpdateCurrentUserCommandHandler(UserManager<User> userManager, IMapper mapper, IUserIdAndOrganizationIdRepository userOrganization, IUnitOfWork unitOfWork, ICreateDocumentPath createDocumentPath)
    {
